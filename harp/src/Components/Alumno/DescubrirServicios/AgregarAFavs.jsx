...
import { agregarServicioFavoritoAAlumno, quitarServicioFavoritoDeAlumno } from "../../../services/Alumno";
...
const FavoriteButton = ({ servicioId, serviciosFavoritos, setServiciosFavoritos }) => {
    ...
    return (
        <motion.button
            ...
            className="flex items-center text-white overflow-hidden transition-all duration-300"
