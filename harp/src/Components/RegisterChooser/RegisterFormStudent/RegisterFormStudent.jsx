            ...
            <div className="row w-100">
                ...
                <div className="col-lg-6 d-flex justify-content-center align-items-center">
                    <div className="col-md-10 col-sm-12" style={{ height: '100%', margin: '2em'}}>
                        <h1 className="mb-3" style={{ marginTop: '1.5em', marginBottom: '1.5em'}}>Regístrate Ahora</h1>
                        <p className="mb-4">¿Ya tienes cuenta? <a href="/login">Inicia sesión aquí</a></p>
                ...
                <div className="col-lg-6 d-flex justify-content-center align-items-center" style={{ backgroundColor: '#A5B4FC'}}>
                    <img src={PanaRegister} alt="Register Illustration" style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain' }} />
                </div>
            </div>
        </div>
    );
