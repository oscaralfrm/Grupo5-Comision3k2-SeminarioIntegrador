...
export default function EditServicioForm() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row", height: "100vh", fontFamily: "Roboto", flexWrap: "wrap", marginTop: "10vh" }}>
      ...
      <div style={{ flex: 1, padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", minHeight: "calc(100vh - 290px)" }} className="col-12 col-md-6 col-lg-12 mt-4 mt-md-0 mb-3">
