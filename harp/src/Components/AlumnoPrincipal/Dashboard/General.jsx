      ...
      <div className="row">
        ...
        <div className="col-lg-4 mb-4">
          ...
          <div className="d-flex flex-wrap justify-content-between" style={{ height: "10vw" }}>
            <div className="card me-2 mb-2" style={{ backgroundColor: "#5a189a", color: "#fff", flex: "1 1 30%", height: "100%" }}>
              <div className="card-body text-center d-flex flex-column justify-content-between">
                <h6 className="card-title">Pagados</h6>
                <p className="card-text fs-5 mt-auto">${paid}</p>
              </div>
            </div>
            <div className="card me-2 mb-2" style={{ backgroundColor: "#3c096c", color: "#fff", flex: "1 1 30%", height: "100%" }}>
              <div className="card-body text-center d-flex flex-column justify-content-between">
                <h6 className="card-title">Pendientes</h6>
                <p className="card-text fs-5 mt-auto">${pending}</p>
              </div>
            </div>
            <div className="card" style={{ backgroundColor: "#240046", color: "#fff", flex: "1 1 30%", height: "100%" }}>
              <div className="card-body text-center d-flex flex-column justify-content-between">
