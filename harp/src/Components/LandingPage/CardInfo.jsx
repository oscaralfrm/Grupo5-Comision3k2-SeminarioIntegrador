...
export default function CardInfo() {
  return (
    <div  style={{ marginTop:'11vw', marginBottom: "1rem" }}>
      ...
      <div className="row justify-content-center " style={{marginLeft:'1vw'}} > {/* Espacio entre tarjetas */}
        <div className="col-lg col-md-6 col-sm-12 mb-4"> {/* Columna para la tarjeta 1 */}
          <GenericCard
        ...
        <div className="col-lg-4 col-md-4 col-sm-12"> {/* Columna para la tarjeta 2 */}
          <GenericCard
        ...
        <div className="col-lg-4 col-md-4 col-sm-12"> {/* Columna para la tarjeta 3 */}
          <GenericCard
