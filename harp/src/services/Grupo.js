...
export const createGrupoConHorarios = async (grupoDTO, idServicio) => {
    try {
        const response = await axios.post(`${API_URL}/grupos/con-horarios`, { grupoDTO, idServicio });
        return response.data;  // Suponiendo que la respuesta es el grupo creado con los horarios
    } catch (error) {
